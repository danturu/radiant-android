...
public class HoloCircularProgressBar extends View {
    ...
    private int mBackgroundCircleStrokeWidth = 10;
    ...
    private final RectF mBackgroundCircleBounds = new RectF();
	...
	public HoloCircularProgressBar(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        setProgressWheelSize((int) attributes.getDimension(R.styleable.HoloCircularProgressBar_progress_stroke_width, 10));
        setBackgroundWheelSize((int) attributes.getDimension(R.styleable.HoloCircularProgressBar_background_stroke_width, 10));
	...
	protected void onDraw(final Canvas canvas) {
		...
		// draw the background
		if (!mOverrdraw) {
			canvas.drawArc(mBackgroundCircleBounds, 270, -(360 - progressRotation), false, mBackgroundColorPaint);
		}
	...
	protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        mBackgroundRadius = halfWidth - mBackgroundCircleStrokeWidth * 2;

        mCircleBounds.set(-mRadius, -mRadius, mRadius, mRadius);

        mBackgroundCircleBounds.set(-mBackgroundRadius, -mBackgroundRadius, mBackgroundRadius, mBackgroundRadius);
	 ...
	 *            the new wheel size
	 */
	private void setProgressWheelSize(final int dimension) {
		mCircleStrokeWidth = dimension;
	}

    private void setBackgroundWheelSize(final int dimension) {
        mBackgroundCircleStrokeWidth = dimension;
    }
	...
	private void updateBackgroundColor() {
		...
		mBackgroundColorPaint.setStrokeWidth(mBackgroundCircleStrokeWidth);
